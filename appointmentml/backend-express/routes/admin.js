        ...
        try {
            ...
            const mlSuggestions = [
                ...
                },
                {
                    ...
                    detail:
                        `Projected revenue for ${nextMonthPrediction.month} is ₱${nextMonthPrediction.predictedRevenue.toLocaleString('en-PH')}. Likely range: ₱${nextMonthPrediction.rangeLow.toLocaleString('en-PH')}–₱${nextMonthPrediction.rangeHigh.toLocaleString('en-PH')}.`
                },
                {
                    title:
