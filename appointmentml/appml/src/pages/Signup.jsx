...
export default function Signup() {
    ...
    const inputClass = (field) =>
        `w-full pl-12 pr-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-4 transition-all ${errors[field] ? 'border-red-500 bg-red-50 focus:ring-red-100' : 'border-gray-300 focus:border-purple-600 focus:ring-purple-100'}`
                ...
                >
                    <div className='bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 md:p-10'>
                        <div className='text-center mb-8'>
                            ...
                            <p className='text-gray-600'>Join Timmy Tails</p>
                        </div>
                            ...
                            <form onSubmit={(e) => e.preventDefault()} className='space-y-4'>
                                ...
                                <div className='flex items-start gap-3 pt-2'>
                                    <input type='checkbox' name='agreeTerms' checked={formData.agreeTerms}
                                        onChange={handleInputChange} className='w-5 h-5 rounded border-gray-300 text-purple-600 focus:ring-purple-400 mt-1' />
                                    <label className='text-gray-600 text-sm'>
                                        I agree to the{' '}
                                        <Link to='#' className='text-purple-600 hover:text-purple-700 font-semibold focus:outline-none focus:underline'>Terms and Conditions</Link>
                                        {' '}and{' '}
                                        <Link to='#' className='text-purple-600 hover:text-purple-700 font-semibold focus:outline-none focus:underline'>Privacy Policy</Link>
                                    </label>
                                </div>
                                ...
                                <motion.button
                                    ...
                                    className='w-full bg-gradient-to-r from-purple-600 to-purple-500 text-white py-3 rounded-lg font-bold hover:shadow-lg hover:shadow-purple-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-6 focus:outline-none focus:ring-4 focus:ring-purple-200'
                                >
                            ...
                            <form onSubmit={handleVerifyOtp} className='space-y-5'>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-4 transition-all ${errors.otp ? 'border-red-500 bg-red-50 focus:ring-red-100' : 'border-gray-300 focus:border-purple-600 focus:ring-purple-100'}`}
                                    />
                                ...
                                <div className='flex gap-3'>
                                    <motion.button
                                        ...
                                        disabled={isLoading}
                                        className='flex-1 border-2 border-purple-300 text-purple-700 py-3 rounded-lg font-bold hover:bg-purple-50 transition-all disabled:opacity-50 focus:outline-none focus:ring-4 focus:ring-purple-100'
                                    >
                                        Resend OTP
                                    </motion.button>
                                    <motion.button
                                        ...
                                        className='flex-1 bg-gradient-to-r from-purple-600 to-purple-500 text-white py-3 rounded-lg font-bold hover:shadow-lg hover:shadow-purple-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-4 focus:ring-purple-200'
                                    >
                        ...
                        <p className='text-center text-gray-600 mt-6'>
                            ...
                            <Link to='/login' className='text-purple-600 hover:text-purple-700 font-bold focus:outline-none focus:underline'>Sign in here</Link>
                        </p>
                    </div>
                </motion.div>
            </div>
