...
export default function Contact() {
    ...
    const inputClass = 'w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-purple-600 focus:ring-4 focus:ring-purple-100 transition-all'
                ...
                <div className='max-w-4xl mx-auto'>
                    ...
                    <div className='grid md:grid-cols-2 gap-8 mb-8'>
                        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}
                            ...
                            {[
                                ...
                                <div key={label} className='flex gap-4 items-start'>
                                    ...
                                    <div>
                                        ...
                                        <a href={href} className='text-gray-600 hover:text-purple-600 transition-colors focus:outline-none focus:text-purple-600'>{value}</a>
                                    </div>
                                </div>
                            ))}
                            ...
                            <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={() => navigate('/booking')}
