            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                        ...
                        <div className='flex gap-3 mt-6'>
                            {socials.map(({ label, href, path }) => (
                                <motion.a
                                    ...
                                    aria-label={label}
                                    title={label}
                                    className='p-2.5 rounded-lg bg-gray-800 hover:bg-purple-600 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-gray-900'
                                >
                                    <svg viewBox='0 0 24 24' width={18} height={18} fill='currentColor' className='text-gray-300'>
                                        <path d={path} />
                                    </svg>
                                </motion.a>
                            ))}
                        ...
                        <ul className='space-y-3'>
                            {[
                                ...
                                <li key={link.label}>
                                    <Link
                                        to={link.href}
                                        className='text-gray-400 hover:text-purple-400 transition-colors font-medium text-sm focus:outline-none focus:text-purple-400'
                                    >
                                        {link.label}
                                    </Link>
                                </li>
                        ...
                        <div className='space-y-4'>
                            <div className='flex items-start gap-3'>
                                ...
                                <div>
                                    ...
                                    <a href='tel:+639756692647' className='text-white hover:text-purple-400 transition-colors font-medium'>
                                        (+63) 975-669-2647
                                    </a>
                                </div>
                            </div>
                            <div className='flex items-start gap-3'>
                                ...
                                <div>
                                    ...
                                    <a href="#NA" className='text-white hover:text-purple-400 transition-colors font-medium'>
                                        NA
                                    </a>
                                </div>
                            </div>
                ...
                <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
                    ...
                    <div className='flex gap-6 text-sm'>
                        <Link to='#' className='text-gray-400 hover:text-purple-400 transition-colors'>Privacy Policy</Link>
                        <Link to='#' className='text-gray-400 hover:text-purple-400 transition-colors'>Terms of Service</Link>
                    </div>
                </div>
            </div>
        </footer>
